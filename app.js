...
t("Złowroga zjawa","Upiory","Upiór",4,16,1,4,1,2,"Wyszczerbiony miecz 3 (4/16), Okrutna włócznia 2 (4/14, Celny Atak)","Upodobanie do Ciemności. W ciemności jego rzuty na atak są Wzmocnione.\nStrach przed Ogniem. Traci 1 Nienawiść na początku rundy, gdy walczy z przeciwnikiem niosącym płonący przedmiot.","Chyża, Przezorna"),
t("Istota z bagien","Upiory","Upiór",3,12,1,3,0,1,"Kły 3 (3/14, Celny Atak), Pazury 2 (3/14, Pochwycenie)","Strach przed Ogniem. Traci 1 Nienawiść na początku rundy, gdy walczy z przeciwnikiem niosącym płonący przedmiot.\nWstręt do Słońca. Traci 1 Nienawiść w każdej turze w bezpośrednim świetle słońca.","Popędliwa, Nieuchwytna"),
t("Dziki wilk","Wilki i bestie","Wilk",3,12,1,3,0,1,"Kły 3 (3/14, Celny Atak)","Strach przed Ogniem. Traci 1 Nienawiść na początku rundy, gdy walczy z przeciwnikiem niosącym płonący przedmiot.\nWężowa Szybkość. Gdy jest atakowany, wydaj 1 Nienawiść, aby Osłabić test trafienia.","Bystrooki, Ponury"),
t("Przewodnik watahy","Wilki i bestie","Wilk",4,16,1,4,0,1,"Kły 3 (3/14, Celny Atak)","Strach przed Ogniem. Traci 1 Nienawiść na początku rundy, gdy walczy z przeciwnikiem niosącym płonący przedmiot.\nWężowa Szybkość. Gdy jest atakowany, wydaj 1 Nienawiść, aby Osłabić test trafienia.\nTriumfalne Wycie. Wydaj 1 Nienawiść, aby przywrócić po 1 Nienawiści pozostałym wargom w potyczce.","Chyży, Zaciekły"),
t("Pies Saurona","Wilki i bestie","Wilk",5,20,2,5,1,2,"Kły 3 (5/14, Celny Atak), Pazury 3 (5/14, Pochwycenie)","Śmiercionośne Uderzenie. Cele zranione przez niego Osłabiają rzut kością Działania przy ustalaniu skutków Rany.\nOhydna Żywotność. Cios obniżający Wytrzymałość do zera tylko Przełamuje Obronę; jeżeli przetrwa, odzyskuje całą Wytrzymałość.\nWzbudzenie Strachu. Wydaj 1 Nienawiść: wszyscy Bohaterowie w zasięgu wzroku otrzymują 2 Cienia (Groza).","Chytry, Popędliwy"),
t("Zbir","Źli ludzie","Człowiek",2,8,1,2,0,1,"Pałka 2 (3/12), Łuk 2 (3/14, Celny Atak)","Bojaźliwość. Pod wpływem zadania Przeraź Wroga traci 1 punkt Determinacji.","Zwinny, Przezorny"),
t("Herszt bandytów","Źli ludzie","Człowiek",3,12,1,3,1,2,"Krótki miecz 3 (3/16), Łuk 2 (3/14, Celny Atak)","Triumfalny Wrzask. Wydaj 1 Determinację, aby przywrócić po 1 Determinacji pozostałym bandytom w potyczce.","Bezwzględny, Skryty"),
t("Rozbójnik","Źli ludzie","Człowiek",4,16,1,4,0,2,"Włócznia 3 (4/14, Celny Atak), Łuk 2 (3/14, Celny Atak)","Wężowa Szybkość. Gdy jest atakowany, wydaj 1 Determinację, aby Osłabić test trafienia.","Chyży, Mściwy"),
t("Najeźdźca z Południa","Źli ludzie","Człowiek",4,16,1,4,1,2,"Topór 3 (5/18), Krótka włócznia 2 (3/14, Celny Atak)","Wojowniczość. Wydaj 1 Determinację, aby dodać 1k i Wzmocnić rzut na atak.","Sprytny, Zahartowany"),
t("Mocarz z Południa","Źli ludzie","Człowiek",5,20,1,5,2,3,"Włócznia 3 (4/14, Celny Atak), Topór na długim stylisku 3 (6/18, Strzaskanie Tarczy)","Wojowniczość. Wydaj 1 Determinację, aby dodać 1k i Wzmocnić rzut na atak.","Okrutny, Mocarny")];
...
$("#category-filters").onclick=e=>{if(e.target.matches("button")){activeCategory=activeCategory===e.target.dataset.category?null:e.target.dataset.category;renderLibrary()}};$("#library-search").oninput=renderLibrary;$("#library-list").onclick=e=>{let c=e.target.closest(".library-card");if(!c)return;let x=[...bookCatalog,...library].find(v=>v.id===c.dataset.id&&v.source===c.dataset.source);if(e.target.closest(".add")){addToBattle(x);document.querySelector('[data-tab="map"]').click()}else if(e.target.closest(".delete")){if(confirm(`Czy na pewno usunąć przeciwnika „${x.name}” z biblioteki?`))store.removeLibrary(x.id)}else loadEditor(x)};
